...
window.WR_SITE_DATA = {
  ...
  "home": {
    ...
    "subhead": "Premium ingredients, careful technique, and a modern vibe \u2014 built for cravings and crafted with care.",
  ...
  "menu": {
    "intro": "A clean, premium menu that\u2019s easy to scan. Replace names, descriptions, and prices anytime in site-data.js.",
    "sections": [
      {
        "title": "Signature Sushi",
        "items": [
          {
            "name": "Wholly Rolly Signature",
            "desc": "House favorite build \u2014 rich, bright, balanced.",
            "price": "$\u2014"
          },
          {
            "name": "Inferno Sushi",
            "desc": "Heat + sweetness + finish that lingers.",
            "price": "$\u2014"
          },
          {
            "name": "Seasonal Special",
            "desc": "Rotating premium cut combo.",
            "price": "$\u2014"
          }
        ]
      },
      {
        ...
        "items": [
          {
            "name": "Salmon",
            "desc": "Clean, buttery, fresh finish.",
            "price": "$\u2014"
          },
          {
            "name": "Tuna",
            "desc": "Bright, lean, classic.",
            "price": "$\u2014"
          },
          {
            "name": "Premium Cut",
            "desc": "Limited daily \u2014 ask what\u2019s best today.",
            "price": "$\u2014"
          }
        ]
      },
      {
        ...
        "items": [
          {
            "name": "California",
            "desc": "Crab, avocado, cucumber, sesame.",
            "price": "$\u2014"
          },
          {
            "name": "Spicy Tuna",
            "desc": "Spicy tuna blend, crunch, bright finish.",
            "price": "$\u2014"
          },
          {
            "name": "Veggie",
            "desc": "Fresh, crisp, clean.",
            "price": "$\u2014"
          }
        ]
      },
      {
        ...
        "items": [
          {
            "name": "Ramune",
            "desc": "Japanese soda (assorted flavors).",
            "price": "$\u2014"
          },
          {
            "name": "Iced Tea",
            "desc": "Refreshing and crisp.",
            "price": "$\u2014"
          },
          {
            "name": "Water",
            "desc": "Because balance.",
            "price": "$\u2014"
          }
        ]
      }
    ...
    "sellout_note_text": "Some sushi sells out when premium cuts run out. If your first pick is gone, ask what\u2019s amazing today \u2014 we\u2019ll guide you."
  },
  "order": {
    "title": "Order Online",
    ...
    "steps": [
      {
        "title": "Choose",
        "text": "Pick your favorites \u2014 nigiri, sashimi, classics, and specials."
      },
      {
        "title": "Checkout",
        "text": "Select pickup/delivery and a time that works for you."
      },
      {
        "title": "Enjoy",
        "text": "Freshly made and beautifully packed \u2014 ready to crush."
      }
    ]
  },
  "sushi101": {
    ...
    "limited": {
      ...
      "chef_text": "Ah! Great question. Some of our sushi is limited each day because we break down whole fish for premium cuts. When a prized cut is gone, it\u2019s gone until the next prep.",
      "sidekick_title": "Chibi Sidekick",
      "sidekick_text": "So it\u2019s like\u2026 a cow only has so many ribeyes? \ud83d\udc04",
      "chef2_title": "Chibi Chef",
      "chef2_text": "Exactly. We could use pre-cut, pre-portioned fish to keep everything stocked\u2026 but premium texture and flavor often suffer. We choose quality over shortcuts.",
